...
(function () {
    ...
    try {
        ...
        globalThis.x.defineCasts = (function(prototype, casts) {
			...
			return Object.defineProperties(prototype, casts.reduce((obj, cast) => {
				obj[cast] = {
					configurable: true,
                    enumerable: false,
                    get() {
        ...
        globalThis.Char = globalThis.x.nativeToString(Object.setPrototypeOf(function Char(...args) {
        ...
        globalThis.Byte = globalThis.x.nativeToString(Object.setPrototypeOf(function Byte(...args) {
        ...
        globalThis.Int8 = globalThis.x.nativeToString(Object.setPrototypeOf(function Int8(...args) {
			if (!new.target) return new Int8(...args);

			return new (class Int8 extends globalThis.Byte {})(...args);
		}, globalThis.Byte));

        globalThis.Short = globalThis.x.nativeToString(Object.setPrototypeOf(function Short(...args) {
		...
		}, globalThis.Number)).bind(globalThis.Number);

        globalThis.Int16 = globalThis.x.nativeToString(Object.setPrototypeOf(function Int16(...args) {
			if (!new.target) return new Int16(...args);

			return new (class Int16 extends globalThis.Short {})(...args);
		}, globalThis.Short));

        globalThis.Number = globalThis.x.nativeToString(Object.setPrototypeOf(function Number(...args) {
			if (!new.target) return NATIVE_NUMBER(...args);

			return new Proxy(new (class Number extends NATIVE_NUMBER {
				constructor(...args) {
					super(...args);
		...
		}, NATIVE_NUMBER)).bind(NATIVE_NUMBER);

        globalThis.String = globalThis.x.nativeToString(Object.setPrototypeOf(function String(...args) {
			...
			return new Proxy(new (class String extends NATIVE_STRING {})(...args), {
				get(...args) {
					if (
						...
						parseInt(args[1]) < 0 &&
						parseInt(args[1].slice(1)) <= args[0].length
		...
		}, NATIVE_STRING)).bind(NATIVE_STRING);

		globalThis.Boolean = globalThis.x.nativeToString(Object.setPrototypeOf(function Boolean(...args) {
		...
		}, NATIVE_BOOLEAN)).bind(NATIVE_BOOLEAN);

		globalThis.BigInt = globalThis.x.nativeToString(Object.setPrototypeOf(function BigInt(...args) {
		...
		}, NATIVE_BIGINT)).bind(NATIVE_BIGINT);
		...
		}, NATIVE_ARRAY)).bind(NATIVE_ARRAY);
        ...
        globalThis.x.defineCasts(globalThis.Char.prototype, [
			...primitives,
			globalThis.Char,
            ...wrappers,
        ]);

        globalThis.x.defineCasts(globalThis.Byte.prototype, [
			...primitives,
			globalThis.Byte,
			globalThis.Int8,
            globalThis.Short,
        ...
        globalThis.x.defineCasts(globalThis.Short.prototype, [
			...primitives,
			globalThis.Short,
			globalThis.Int16,
            ...wrappers,
        ...
        globalThis.x.defineCasts(globalThis.Number.prototype, [
			...primitives,
            ...wrappers,
        ]);

        globalThis.x.defineCasts(globalThis.String.prototype, [
			...primitives,
            ...wrappers,
        ]);

		globalThis.x.defineCasts(globalThis.Boolean.prototype, [
			...primitives,
            ...wrappers,
        ]);
